...
# [HM] I took the following code from the given source and exchanged to functionality
# of + and - with that of * and / while keeping the grammar an thus the function structure,
# to get the effect of the task, to implement an exchange of the operator precedence
# of + and - with that of * and /.
    ...
    def parseAddition(self):
        ...
        while True:
            ...
            if char == '*':
                ...
                self.index += 1
                values.append(1.0 / self.parseMultiplication())
            else:
                break
        value = 1.0
