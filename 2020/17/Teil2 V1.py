...
def sizes(wv, xv, yv, zv, wt, xt, yt, zt):
    na = 0
...
#printstate (0, 0, 0, 0, sz-1, sz-1, sz-1, sz-1)

na, wv, xv, yv, zv, wt, xt, yt, zt = sizes(0, 0, 0, 0, sz-1, sz-1, sz-1, sz-1)
...
for cycle in range(0,6): # 6
    ...
    na, wv, xv, yv, zv, wt, xt, yt, zt = sizes( wv, xv, yv, zv, wt, xt, yt, zt )
